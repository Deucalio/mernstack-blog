...
const DeletePopup = ({ displayDeleteArticlePopUp }) => {
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col items-center gap-4 lg:px-6">
          ...
          <div className="mt-5 flex flex-wrap gap-4 self-end sm:mt-8">
            <button
              onClick={() => displayDeleteArticlePopUp(false)}
            ...
            <button
              onClick={() => displayDeleteArticlePopUp(true)}
      ...
      <div className="absolute top-0 bottom-0 left-0 right-0 z-40 bg-black/70"></div>
    </>
  );
};
